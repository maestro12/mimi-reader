...
public class CatalogPostModel extends BaseModel implements PostConverter {
    public static final String TABLE_NAME = "catalog_posts";
    ...
    public CatalogPostModel() { }

    public CatalogPostModel(CatalogPostModel other) {
        copyValuesFrom(other);
    }

    public CatalogPostModel(ChanPost other) {
    ...
    public void copyValuesFrom(BaseModel model) {
        if (model instanceof CatalogPostModel) {
            CatalogPostModel other = (CatalogPostModel) model;
