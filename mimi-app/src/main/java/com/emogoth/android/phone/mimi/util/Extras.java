...
public class Extras {
    ...
    public final static String EXTRAS_BOARD_NAME = NAMESPACE + "board_name";
    public final static String EXTRAS_BOARD_TITLE = NAMESPACE + "board_title";
    ...
    public final static String EXTRAS_PAGE = NAMESPACE + "page";
    ...
    public final static String EXTRAS_FROM_URL = NAMESPACE + "from_url";
    ...
    public final static String PREF_FETCH_CATALOG = "use_catalog_pref";
