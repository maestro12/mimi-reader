...
// From https://github.com/willblaschko/header-footer-recycler-view/blob/master/app/src/main/java/com/willblaschko/android/headerfooterrecyclerview/RecyclerViewHeaderFooterAdapter.java
...
public class RecyclerViewHeaderFooterAdapter extends RecyclerView.Adapter {
    ...
    public interface IRecyclerViewIntermediary {
        ...
        RecyclerView.ViewHolder getViewHolder(ViewGroup viewGroup, int type);
        int getItemViewType(int position);
        void populateViewHolder(RecyclerView.ViewHolder viewHolder, int position);
    }
