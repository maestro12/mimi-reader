 ...
 */
public class ExoPlayerHelper implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link ExoPlayerHelper#onRenderers}
         *               should be invoked once the renderers have been built. If building fails,
         *               {@link ExoPlayerHelper#onRenderersError} should be invoked.
         */
        void buildRenderers(ExoPlayerHelper player);

        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p/>
         * A canceled build operation must not invoke {@link ExoPlayerHelper#onRenderers} or
         * {@link ExoPlayerHelper#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
    ...
    private int audioTrackToRestore = -1;
